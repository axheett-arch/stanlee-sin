    ...
    <div class="py-5">
        <div class="row align-items-center mb-5 pb-5">
            <div class="col-lg-7">
                ...
                <p class="fs-5 text-secondary fw-light" style="line-height: 1.6;">
                    <span class="text-white fw-bold">StanLee Sin</span> no nació en una oficina, nació en las aulas de <span
                        class="text-magenta">Taller de Programación I</span>.
                    Surgió como un glitch en el sistema: la necesidad de fusionar la durabilidad de los productos Stanley
                    con la agilidad y el estilo de la cultura urbana.
                </p>
                <div class="p-3 border-start border-magenta bg-black my-4">
                    <p class="text-white mb-0 italic">
                        "El nombre es un tributo al monje ciego de League of Legends: Enfoque absoluto, resistencia
                        legendaria y visión donde otros no ven nada."
                    </p>
                </div>
                <p class="fs-5 text-secondary fw-light">
                    Nuestro objetivo es que cada equipo sea una declaración de principios. Queremos que tu herramienta
                    diaria sea tan dura como el acero y tan única como una <span
                        class="text-white fw-bold">pentakill</span>.
                </p>
            </div>
        ...
        <div class="row mt-5 pt-5 border-top border-secondary">
            <div class="col-12 text-center mb-5">
                ...
                <p class="text-secondary hansip-font" style="letter-spacing: 2px; font-size: 0.8rem;">THE ARCHITECTS BEHIND
                    THE SYSTEM</p>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card-esencia p-4 h-100 text-center border-magenta">
                    ...
                    <div class="mt-3 pt-3 border-top border-secondary">
                        <span class="text-white small hansip-font" style="font-size: 0.6rem; opacity: 0.5;">DEV_ID:
                            001-AXEL</span>
                    </div>
                </div>
            </div>
