...
<nav class="navbar navbar-dark bg-black border-bottom border-magenta py-3">
    <div class="container-fluid px-4">
        ...
        <div class="d-flex align-items-center">
            <a href="/catalogo" class="nav-link hansip-font d-none d-md-block px-3" style="font-size: 0.9rem;">CATALOGO</a>
            <a href="/consultas" class="btn btn-outline-light btn-sm hansip-font ms-2" style="border-color: #c80d55; color: #c80d55; font-size: 0.8rem;">
                CONSULTAS
            </a>
        </div>
    </div>
...
<div class="offcanvas offcanvas-start bg-black text-white border-end border-magenta"
     tabindex="-1" id="menuLateral" style="width: 300px;">
