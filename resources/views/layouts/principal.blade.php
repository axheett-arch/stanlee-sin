...
@section('contenido')
        ...
        <div class="col-lg-5 text-center mt-5 mt-lg-0">
           <div class="position-relative d-inline-block">
                <div class="position-absolute top-50 start-50 translate-middle w-100 h-100"
                    style="background: radial-gradient(circle, rgba(200,13,85,0.4) 0%, rgba(200,13,85,0.1) 50%, transparent 75%);
    ...
    <div class="row mt-5 py-5 border-top border-secondary text-center">
        ...
        <div class="col-md-4 px-4 mb-4 mb-md-0">
            <div class="p-4 border border-secondary h-100 card-esencia" style="background: #0a0a0a;">
                <h3 class="hansip-font h4 text-white mb-3">RESISTENCIA</h3>
                <p class="text-secondary small">Acero inoxidable de alto grado. Bancan cualquier golpe en el mosh o en la calle.</p>
            </div>
        </div>
        ...
        <div class="col-md-4 px-4 mb-4 mb-md-0">
            <div class="p-4 border border-secondary h-100 card-esencia" style="background: #0a0a0a;">
                ...
                <p class="text-secondary small">Diseños únicos con la impronta de <span class="text-magenta">Axel y Tiago</span>.</p>
            </div>
        </div>
        ...
        <div class="col-md-4 px-4">
            <div class="p-4 border border-secondary h-100 card-esencia" style="background: #0a0a0a;">
                ...
                <p class="text-secondary small">Como dice el nombre: <span class="text-white fw-bold">StanLee Sin</span> fallas. Dura toda la vida.</p>
            </div>
        </div>
    </div>
@endsection
