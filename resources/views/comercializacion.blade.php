    ...
    <div class="py-5">
        <div class="text-center mb-5">
            ...
            <p class="text-secondary hansip-font" style="letter-spacing: 3px; font-size: 0.8rem;">
                DISTRIBUCIÓN EFECTIVA Y LOGÍSTICA ORGANIZADA
            </p>
        </div>
            ...
            <div class="col-md-6">
                <div class="card-esencia p-4 h-100 border-magenta">
                    ...
                    <ul class="list-unstyled text-secondary">
                        <li class="mb-4">
                            <strong class="text-white d-block hansip-font mb-1" style="font-size: 0.9rem;">ENTREGAS
                                LOCALES:</strong>
                        ...
                        <li class="mb-4">
                            <strong class="text-white d-block hansip-font mb-1" style="font-size: 0.9rem;">DESPACHOS
                                NACIONALES:</strong>
                            Envíos a todo el país vía <span class="text-white">Correo Argentino</span>.
                            Salidas programadas: Martes y Viernes.
                        </li>
                        <li class="mb-0">
                            <strong class="text-white d-block hansip-font mb-1" style="font-size: 0.9rem;">PUNTO DE
                                EXTRACCIÓN:</strong>
                            Retiro sin cargo en nuestro <span class="text-magenta fw-bold">Búnker</span> (Descartes 1184).
            ...
            <div class="col-md-6">
                <div class="card-esencia p-4 h-100">
                    ...
                    <div class="d-flex flex-column gap-3">
                        <div
                            class="p-3 border border-secondary bg-black d-flex justify-content-between align-items-center transition-all hover-magenta">
                            <div>
                        ...
                        <div class="p-3 border border-secondary bg-black">
                            ...
                            <p class="text-secondary small mb-0 mt-1">Alias: <span
                                    class="text-white">StanLee.Sin.Corrientes</span></p>
                        </div>
